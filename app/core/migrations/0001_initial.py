# Generated by Django 4.0.10 on 2024-10-28 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teamseason', to='core.season')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='team_season', to='core.team')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wins', models.IntegerField(default=0)),
                ('losses', models.IntegerField(default=0)),
                ('racks_won', models.IntegerField(blank=True, default=0, null=True)),
                ('racks_lost', models.IntegerField(blank=True, default=0, null=True)),
